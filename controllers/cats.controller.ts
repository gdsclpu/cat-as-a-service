...
export default class CatController extends CatSerice {
    ...
    public async getRandomCatByBreed(req: Request, res: Response, next: NextFunction) {
        try {
    ...
    public async getRandomCatByAge(req: Request, res: Response, next: NextFunction) {
        try {
    ...
    public async getRandomCatBySize(req: Request, res: Response, next: NextFunction) {
        try {
    ...
    public async getAllCatBreeds(req: Request, res: Response, next: NextFunction) {
        try {
